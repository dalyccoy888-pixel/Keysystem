...
local Config = {
    ...
    ServiceId       = 22782, -- Your PlatoBoost Service ID
    PlatoSecret     = "8ba594b4-985f-4434-9dc4-d282ee3cc9ee", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "lyybigber", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/dalyccoy888-pixel/Keysystem/refs/heads/main/Script.lua", -- The raw URL of your main script
    ...
    HubName         = "TOREN HUB", -- The main title shown at the top of the GUI
    HubDescription  = "Welcome" -- The text shown below the title
}
